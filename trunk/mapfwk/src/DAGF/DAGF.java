 ...
 */
public class DAGF implements Cloneable, Serializable
{
    //------------------------------------------------------------
    //Fields
    //------------------------------------------------------------
    ...
    public Vertex addVertex( final Vertex v )
    {
        ...
        // check if vertex is alredy in DAG
        if ( vertexMap.containsKey( v.getLabel() ) )
        {
            retValue = (Vertex)vertexMap.get(v.getLabel());
        }
        else
        {
            retValue = v;

            vertexMap.put( v.getLabel(), retValue );
